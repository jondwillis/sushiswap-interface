...
import { Currency, ETHER, TokenAmount, WETH, currencyEquals } from 'bao-sdk'
...
export default function AddLiquidity({
    ...
    return (
        <>
            ...
            <div className="bg-light-900 w-full max-w-2xl rounded z-10 shadow-liquidity-purple-glow">
                ...
                <Wrapper>
                    ...
                    <AutoColumn gap="md">
                        ...
                        <AutoColumn justify="space-between">
                            ...
                            >
                                <button className="bg-light-900 rounded-full p-3px -mt-6 -mb-6 z-10">
                                    <div className="bg-light-800 hover:bg-light-700 rounded-full p-3">
