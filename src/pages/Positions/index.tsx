...
export default function Positions() {
    ...
    return (
        <>
            ...
            <div className="bg-light-900 w-full max-w-2xl rounded mb-3 p-4">
                <div className="flex justify-between">
                    <div className="flex">
                        <div className="p-1.5 bg-light-800 rounded">
            ...
            <div className="bg-light-900 w-full max-w-2xl rounded p-4">
                <div className="w-auto flex justify-between items-center rounded bg-light-800 p-0.5 whitespace-nowrap text-sm font-bold cursor-pointer select-none pointer-events-auto mt-3 mb-6">
                    <Link
                        to={'/pool'}
                        className={`w-3/6 p-3 text-center rounded-lg text-primary text-bold bg-light-900 `}
                    >
