...
function Web3Faucet(): JSX.Element | null {
    ...
    return (
        ...
        >
            <div className="grid grid-flow-col auto-cols-max items-center rounded-lg bg-light-1000 text-sm text-secondary py-2 px-3 pointer-events-auto text-primary">
                Claim Test Tokens
            </div>
            <FaucetModal />
        </div>
