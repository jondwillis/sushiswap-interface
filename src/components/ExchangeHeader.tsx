        ...
        <div className="flex justify-between space-x-3 pt-4 px-4">
            <div className="grid grid-cols-2 rounded-md p-3px md:bg-light-800">
                ...
                {/* <NavLink
                    ...
                    activeClassName="bg-light-900 text-high-emphesis"
                    to="/limit-order"
                >
                    Limit Order
                </NavLink> */}
            ...
            <div className="flex items-center rounded md:border-2 md:border-light-800 md:p-2">
                <div className="grid grid-flow-col gap-3">
                    {/* <div className="hidden md:flex space-x-3 items-center bg-light-800 hover:bg-light-700 rounded-sm h-full w-full px-2 py-1.5 cursor-pointer">
                    ...
                    <div className="bg-light-800 hover:bg-light-700 rounded-sm h-full w-full p-1 md:px-2">
                        <Settings />
                    </div>
                    {/* <button
                        onMouseEnter={() => setAnimateSettings(true)}
                        onMouseLeave={() => setAnimateSettings(false)}
                        className="flex items-center justify-center bg-light-800 hover:bg-light-700 rounded-sm h-full w-full p-1 md:px-2"
                    >
                        <Lottie
                    ...
                    {/* <button
                        ...
                        className="hidden md:flex items-center justify-center bg-light-800 hover:bg-light-700 rounded-sm h-full w-full px-2"
                    >
                        <Lottie
