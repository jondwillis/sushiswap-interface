...
const items = (i18n: I18n) => [
    ...
    },
    {
        ...
        href: 'https://discord.gg/jec6nQYBpk'
    }
]
                    ...
                    >
                        ...
                        >
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                <div className="relative grid gap-6 bg-light-900 px-5 py-6 sm:gap-8 sm:p-8">
                                    {solutions.map(item => (
                                        <ExternalLink
                                            key={item.name}
                                            href={item.href}
                                            className="-m-3 p-3 block rounded-md hover:bg-light-800 transition ease-in-out duration-150"
                                        >
